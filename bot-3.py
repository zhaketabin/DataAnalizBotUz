...
TX = {
    "uz": {
        "promo": "🎉 Muborak! 1-may kuniga qadar BEPUL foydalaning!
⚡ Faqat birinchi 200 ta foydalanuvchi uchun!
...
",
    ...
    "kz": {
        "promo": "🎉 Құттықтаймыз! 1 майға дейін ТЕГІН пайдаланыңыз!
⚡ Тек алғашқы 200 пайдаланушы үшін!
...
",
    ...
    "ru": {
        "promo": "🎉 Поздравляем! Пользуйтесь БЕСПЛАТНО до 1 мая!
⚡ Только для первых 200 пользователей!
...
",
    ...
    "en": {
        "promo": "🎉 Congratulations! Use FREE until May 1st!
